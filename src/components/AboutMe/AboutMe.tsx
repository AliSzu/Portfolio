  ...
  return (
    <div className={`container ${classes["container-aboutMe"]}`}>
      <div className={"wrapper"} ref={ref}>
        ...
        <div
          ref={containerRef}
          className={`${classes.card} ${isVisible && "fade_in"}`}
        >
          <div>
            <span className={classes.text}>
              I'm Alicja a dedicated <b>third-year Computer Science student</b>{" "}
              with a strong focus on becoming a Frontend developer! I am also an
              active member of the <b>programming scientific club, BYTE_IT</b>{" "}
              where I continuously challenge myself and enhance my skills. With
              a solid foundation in Computer Science, I aim to create engaging
